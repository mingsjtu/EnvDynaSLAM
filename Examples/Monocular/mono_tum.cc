...
vector<double> &vTimestamps1,vector<double> &vTimestamps2,map<double,double> &mTimestamps_map);
int main(int argc, char **argv)
{
    ...
    map<double,double> mTimestamps_map;
    LoadImages(strFile, vstrImageFilenames1,vstrImageFilenames2, vTimestamps1,vTimestamps2,mTimestamps_map);
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        //get env mask
        //im_env = cv::imread(string(env_dir)+"/"+vstrImageFilenames1[ni],CV_LOAD_IMAGE_UNCHANGED);
